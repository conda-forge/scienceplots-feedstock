...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/scienceplots-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14605&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/scienceplots-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `scienceplots` can be installed with:

```
conda install scienceplots
```

It is possible to list all of the versions of `scienceplots` available on your platform with:
